    ...
    return AppScaffold(
      ...
      body: ListView(
        ...
        children: [
          Container(
            ...
            child: Row(
              children: [
                Stack(
                  children: [
                    UserAvatar(nome: perfil.nome, fotoPath: perfil.fotoPath, radius: 26),
                    Positioned(
                      right: -2,
                      bottom: -2,
                      child: Material(
                        ...
                        child: InkWell(
                          ...
                          onTap: () async {
                            ...
                            context.read<AppDataService>().atualizarFotoPerfil(caminho);
                          },
                          child: const Padding(
                            padding: EdgeInsets.all(5),
                            child: Icon(Icons.photo_camera_outlined, size: 13, color: Colors.white),
                          ),
                        ),
                      ),
                    ),
          ...
          //A pagina de Sobre estara no icone da marca
